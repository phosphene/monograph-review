#' Contract validators for the foundry data
#'
...
#' non-independence of species due to shared evolutionary history. The framework's
...
#' @section Theoretical Context:
#'
#' Plastome data tests the framework's prediction that genome reduction tracks
...
#' @section Theoretical Context:
#'
#' The parasitism score is the framework's integration-depth proxy for Orobanchaceae:
...
#' @section Theoretical Context:
#'
#' Endosymbiont data tests the framework's biphasic kinetics prediction: fast
...
#' as the framework — this test does NOT distinguish the framework from McCutcheon.
#'
#' @dft
#' - A1 (pure-io-separation): pure function
#'
...
#' @section Theoretical Context:
#'
#' Gene category data tests the framework's integration-depth ordering prediction:
...
#' no ordering. This test DOES distinguish the framework from random loss — it is
...
#' test DOES distinguish the framework — it is the strongest test in the monograph.
#'
#' @dft
#' - A1 (pure-io-separation): pure function
#'
...
#' (0–5). The framework predicts: higher dependency → higher retention (dep > 0);
...
#' @section Theoretical Context:
#'
#' Bobay-Ochman data tests the framework's prediction that niche breadth predicts
#' gene loss better than Ne alone. The competitor (drift, Lynch 2007)
#' predicts Ne is the primary driver. This test DOES distinguish the framework
...
#' @section Theoretical Context:
#'
#' Pangenome data tests the framework's prediction that pan-genome openness tracks
...
#' DOES distinguish the framework from the Ne-only model.
#'
#' @dft
#' - A1 (pure-io-separation): pure function
#'
