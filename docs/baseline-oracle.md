...
- **Supports the framework** — does the result support the framework prediction?
- **Distinguishes from competitor** — does the result distinguish the framework from a named competitor hypothesis?

Where `distinguishes_from_competitor: false`, the **caveat** field explains why. The foundry does not hide non-discriminating results — it labels them. A result that supports the framework but does not distinguish it from relaxed selection is reported as exactly that, not as evidence for the framework uniquely.
...
**Supports the framework:** Yes
**Distinguishes from competitor:** No
**Competitor:** Relaxed selection (Lahti et al., 2009) — predicts the same gradient
**Caveat:** Relaxed selection predicts the same pattern. The result is consistent with the framework but does not discriminate it from the relaxed-selection alternative. The discriminating signal is in T4 and T6.
...
**Supports the framework:** Yes (suggestive)
**Distinguishes from competitor:** No
