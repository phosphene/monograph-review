# Toy Models — Speculative Explorers

## What These Are

The toy models are interactive **simulations** — computational models that generate synthetic data from framework's equations and visualize the trajectory under different parameter settings. They are **not tests** of the hypothesis. They are tools for building intuition about how the framework's mechanisms operate. Each model generates data from known equations, lets the user adjust parameters, and shows what the trajectory looks like under different conditions.
...
### Model 2 — Irreversibility (The Cusp Catastrophe)
...
### Model 4 — Cross-Kingdom Transfer (Model vs Sign-Only)
