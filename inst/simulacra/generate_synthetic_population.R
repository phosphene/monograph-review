...
# Generates a synthetic trait panel from the framework threshold-gated capacity
...
#' Generate a synthetic trait population from the framework threshold model
#'
...
#' higher parasitism → smaller plastome (the framework signal the recovery test
#' must detect).
#'
