...
#
# Uses the framework-foundry's ggplot2 + viridis + patchwork ecosystem to produce
...
# ---------------------------------------------------------------------------
# 1. Shared theme (matches the foundry viz.R aesthetic)
# ---------------------------------------------------------------------------
...
# Color palette (viridis-based, matching the foundry style)
valence_colors <- list(
...
body_html <- paste0(
'<div class="section">
<h2>GRN Simulation Review — the framework under review</h2>
<div class="summary">
<p><strong>What this is:</strong> Computational verification of the bi-exponential relaxation prediction
across GRN topologies. The framework predicts that organisms with multi-level integration
...
<title>GRN Simulation Review — The Foundry</title>
<style>', CSS, '</style>
</head>
<body>
<div class="header">
...
', body_html, '
<div class="footer">
<p><strong>The Foundry</strong> — generated by <code>scripts/render_simulation_review.R</code> at ', timestamp, '</p>
</div>
</body>
</html>
'
