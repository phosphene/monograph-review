...
Valence = Path("/home/node/.openclaw/workspace/valence-foundry")
DATA_DIR = valence / "data" / "blast_orthology"
DEP_SCORES = valence / "data" / "t7-ltee" / "gene_dependency_scores.tsv"
IJO_GENES = valence / "data" / "t7-ltee" / "sodalis" / "ecoli_gene_names.txt"
