...
#
# The the manuscript claims "consistent with Landau mean-field theory."
...
test_that("Landau: |M_eq| matches sqrt(-a/2) theoretical prediction", {
  ...
  if (nrow(landau_below) >= 3) {
    ...
    expect_equal(abs(landau_below$M_eq), theoretical_M,
      tolerance = 0.02,
